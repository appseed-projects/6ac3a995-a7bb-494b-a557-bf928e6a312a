...
- Timestamp: `2022-05-06 14:19`
- Build ID: `6ac3a995-a7bb-494b-a557-bf928e6a312a`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/6ac3a995-a7bb-494b-a557-bf928e6a312a.git
$ cd 6ac3a995-a7bb-494b-a557-bf928e6a312a
```
